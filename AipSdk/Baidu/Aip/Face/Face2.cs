...
namespace Baidu.Aip.Face
{
    ...
    /// 人脸识别
    /// </summary>
    public class Face2 : AipServiceBase   {
        ...
        public Face2(string apiKey, string secretKey) : base(apiKey, secretKey)
        {
        ...
        protected AipHttpRequest2 DefaultRequest(string uri)
        {
            return new AipHttpRequest2(uri)
            {
                Method = "POST",
                BodyType = AipHttpRequest2.BodyFormat.Json,
        ...
        public JObject Match(JArray faces)
        {
            ...
            aipReq.BodyType = AipHttpRequest2.BodyFormat.JsonRaw;
            PreAction();
            aipReq.Bodys[AipHttpRequest2.BodyFormatJsonRawKey] = faces;
            return PostAction2(aipReq);
        ...
        ///     <list type="bullet">
        ///           <item>  <c>face_field</c>: 包括**age,beauty,expression,faceshape,gender,glasses,landmark,race,quality,facetype信息**  <br> 逗号分隔. 默认只返回face_token、人脸框、概率和旋转角度 </item>
